...
export default function Login() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setIsTransformed((prev) => !prev); // Toggle transformation state
    }, 2000); // Every 2 seconds

    return () => clearInterval(interval); // Cleanup on unmount
  }, []);

  const getTransform = (baseTransform, transformedTransform) => {
    return isTransformed ? transformedTransform : baseTransform;
  };
          ...
          <div className="row relative">
            <div className="col-md-5">
              <div className='h-[100vh]'>
                <div className="illustration-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', backgroundColor: '#f9f9f9' }}>
                  <svg
                    width="729"
                    height="741"
                    viewBox="0 0 729 741"
                  ...
                  >
                    ...
                    >
                      ...
                      <rect
                        ...
                        rx="46.5"
                        transform={getTransform(
                          "translate(0, 5) matrix(-0.981653 0.190678 0.190678 0.981653 449.098 425.281)",
                          "matrix(-0.981653 0.190678 0.190678 0.981653 449.098 425.281)",
                        )}
                        style={{ transition: 'transform 1s ease' }}
                        fill="#F47458"
                      />
                      <rect
                        ...
                        height="58"
                        transform={getTransform(
                          "rotate(25, 433.73, 552.041) matrix(-0.898852 0.438251 0.438251 0.898852 433.73 532.041)",
                          "rotate(0, 433.73, 552.041) matrix(-0.898852 0.438251 0.438251 0.898852 433.73 532.041)",
                        )}
                        style={{ transition: 'transform 1s ease' }}
                        fill="#0E60FF"
                      />
                      <path
                        d="M475.345 593.722L580.249 591.95L601.68 516.577L450.702 519.128L450.847 519.567L475.345 593.722Z"
                        fill="#00FFC2"
                      />
                    </g>
                    ...
                    <g >
                      ...
                      <path
                        transform={getTransform(
                          'rotate(0, 698.376, 710.135)',
                          'rotate(15, 698.376, 710.135)'
                        )}
                        style={{ transition: 'transform 1s ease' }}
                        d="M698.376 713.058C689.234 730.029 669.833 737.314 669.833 737.314C669.833 737.314 665.252 717.084 674.394 700.114C683.536 683.143 702.938 675.858 702.938 675.858C702.938 675.858 707.518 696.088 698.376 713.058Z" fill="#201F30" />
                      <path
                        transform={getTransform(
                          'rotate(0, 698.093, 710.135)',
                          'rotate(15, 698.093, 710.135)'
                        )}
                        style={{ transition: 'transform 1s ease' }}
                        d="M692.093 707.475C675.588 717.415 669.232 737.157 669.232 737.157C669.232 737.157 689.635 740.785 706.139 730.845C722.644 720.906 729 701.163 729 701.163C729 701.163 708.597 697.536 692.093 707.475Z" fill="#F47458" />
                    </g>
                    ...
                    <g >
                      ...
                      <path
                        ...
                        style={{ transition: 'transform 1s ease' }}
                        d="M215.589 454.511H289.879C297.129 421.128 297.735 388.875 289.879 358.059H215.589C227.578 388.32 228.327 420.353 215.589 454.511Z" fill="#2B221E" />
                      <path
                        transform={getTransform(
                          'translate(0, -7)',
                          'translate(0, 2)'
                        ...
                        style={{ transition: 'transform 1s ease' }}
                        d="M320.082 408.509L298.11 417.934C298.11 417.934 255.737 424.218 255.737 406.938C255.737 389.657 298.11 399.083 298.11 399.083L312.236 394.562L320.082 408.509Z" fill="#EEE0D9" />
                    </g>
